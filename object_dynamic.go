...
func (o *dynamicObject) MemUsage(ctx *MemUsageContext) (uint64, error) {
	if o.baseDynamicObject.val == nil || o.baseDynamicObject.val.self == nil {
		return SizeEmpty, nil
	}
	if o.baseDynamicObject.val.__wrapped != nil {
		nativeMem, ok := ctx.NativeMemUsage(o.baseDynamicObject.val.__wrapped)
		if ok {
			return nativeMem, nil
		}
	}

	switch x := o.baseDynamicObject.val.self.(type) {
...
func (o *dynamicArray) MemUsage(ctx *MemUsageContext) (uint64, error) {
	if o.baseDynamicObject.val == nil || o.baseDynamicObject.val.self == nil {
		return SizeEmpty, nil
	}
	if o.baseDynamicObject.val.__wrapped != nil {
